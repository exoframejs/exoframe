...
import { getUserConfig, setupMocks } from './util/config.ts';
...
test('Should add new endpoint', async () => {
  ...
  // execute addition
  await program.parseAsync(['endpoint', 'add', mockEndpoint], { from: 'user' });
...
test('Should add second new endpoint', async () => {
  ...
  // execute addition
  await program.parseAsync(['endpoint', 'add', mockEndpoint2], { from: 'user' });
...
test('Should select old endpoint', async () => {
  ...
  // execute switch
  await program.parseAsync(['endpoint'], { from: 'user' });
...
test('Should select old endpoint using URL param', async () => {
  ...
  // execute switch
  await program.parseAsync(['endpoint', mockEndpoint], { from: 'user' });
...
test('Should show error on remove of non-existent endpoint', async () => {
  ...
  // execute switch
  await program.parseAsync(['endpoint', 'rm', 'do-not-exist'], { from: 'user' });
...
test('Should remove current endpoint using enquirer', async () => {
  ...
  // execute switch
  await program.parseAsync(['endpoint', 'rm'], { from: 'user' });
...
test('Should remove existing endpoint using param', async () => {
  ...
  // execute switch
  await program.parseAsync(['endpoint', 'rm', origCfg.endpoint], { from: 'user' });
...
test('Should not remove only endpoint', async () => {
  ...
  // execute switch
  await program.parseAsync(['endpoint', 'rm', mockEndpoint2], { from: 'user' });
