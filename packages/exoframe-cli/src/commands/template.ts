...
import { templateAddHandler } from '../handlers/template/add.ts';
import { templateListHandler } from '../handlers/template/list.ts';
import { templateRemoveHandler } from '../handlers/template/remove.ts';
